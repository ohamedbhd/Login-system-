...
void Calculator ()
{
    ...
    do
    {
        ...
        cout <<"If you want to continue with the calculations press [ y ] or [ n ] : ";
        cin >> respond;
...
void searchStudent()
{
    ...
    if(!found)// بيحول القيمة false الى true
    {
...
// الكود ده بيجمع كل الدوال وينفذ كل لاكودا والمستخدم يدخل رقم العملية ويقدر يستخدم البرنامج
